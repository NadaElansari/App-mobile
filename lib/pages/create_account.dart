          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 30),
                _buildTextField('Full Name', 'ex: Alex Mahone', _fullNameController, TextInputType.name),
                const SizedBox(height: 20),
                _buildTextField('Email', 'ex: URNAME@email.com', _emailController, TextInputType.emailAddress),
                const SizedBox(height: 20),
                _buildTextField('Phone', '+212 6 ** ** ** **', _phoneController, TextInputType.phone),
                const SizedBox(height: 20),
            ...
            children: [
              ...
              InkWell(
                ...
                child: SvgPicture.asset(
                  visible ? 'assets/vectors/view_on_1_x2.svg' : 'assets/vectors/view_off_1_x2.svg',
                  width: 24,
                  height: 24,
                ),
              ),
        ...
        InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              color: _termsAccepted ? const Color(0xFF9C5A46) : Colors.transparent,
            ),
          ),
        ),
      ...
      child: _isLoading
          ...
          : ElevatedButton(
                  ...
                  ? () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        try {
                          ...
                          _showErrorDialog('An unexpected error occurred. Please try again. Error: $e');
                        } finally {
                          setState(() {
                            _isLoading = false;
                          });
              ...
              style: ElevatedButton.styleFrom(
                ...
                backgroundColor: _termsAccepted ? Color(0xFF9C5A46) : Colors.grey,
